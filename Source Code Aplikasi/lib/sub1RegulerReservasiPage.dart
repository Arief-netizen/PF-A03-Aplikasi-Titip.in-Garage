...
import 'package:titipin2/sub2RegulerCheckoutPage.dart';

class sub1RegulerReservasiPage extends StatefulWidget {
  @override
  _sub1RegulerReservasiPageState createState() =>
      _sub1RegulerReservasiPageState();
}

class _sub1RegulerReservasiPageState extends State<sub1RegulerReservasiPage> {
  @override
                ...
                Positioned(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                sub2RegulerCheckoutPage()), // navigasi ke halaman checkout
                      ),
                      child: Container(
                          width: 315,
                          height: 38,
                ...
                Positioned(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => sub2RegulerCheckoutPage()),
                      ),
                      child: Container(
                        decoration: BoxDecoration(),
                        padding:

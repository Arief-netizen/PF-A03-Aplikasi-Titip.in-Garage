...
class subTambahDataMobilPage extends StatefulWidget {
  @override
  _subTambahDataMobilPageState createState() => _subTambahDataMobilPageState();
}

class _subTambahDataMobilPageState extends State<subTambahDataMobilPage> {
